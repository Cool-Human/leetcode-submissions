...
class FlightHero(Hero):
    def __init__(self, name: str, power_level: int, health: int, flight_speed: int) -> None:
...
class StrengthHero(Hero):
    def __init__(self, name: str, power_level: int, health: int, lifting_capacity: int) -> None:
        super().__init__(name, power_level, health)
