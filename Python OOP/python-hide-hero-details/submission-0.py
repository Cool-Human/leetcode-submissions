class SuperHero:
    ...
    def set_health(self, health: int) -> None:
        self.__health = health if (health >= 0 and health <= 100) else print("You can't set the health to more than 100") if health > 100 else print("You can't set the health to less than 0")
    
    def set_power_level(self, power_level: int) -> None:
        self.__power_level = power_level if (power_level > 0 and power_level <= 10) else print("You can't set the power level to more than 10") if power_level > 10 else print("You can't set the power level to less than 1")
...
print(f'Batman has {super_hero.get_health()} health and {super_hero.get_power_level()} power level')
